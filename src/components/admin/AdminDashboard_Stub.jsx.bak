      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            {branch && <p className="text-slate-500 text-sm">Branch ID: {branch.id}</p>}
          </div>
          <button
            onClick={onLogout}
        ...
        <div className="bg-yellow-600/10 border border-yellow-600/30 rounded-xl p-6 mb-6">
          ...
          <p className="text-slate-300">
            The Admin Dashboard is being refactored into smaller, maintainable components.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
            ...
            <p className="text-slate-400 text-sm">Manage clients and accounts</p>
          </div>
          <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
            <h3 className="text-lg font-semibold mb-2">Transactions</h3>
            <p className="text-slate-400 text-sm">Process deposits and withdrawals</p>
          </div>
          <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700">
            <h3 className="text-lg font-semibold mb-2">Reports</h3>
            <p className="text-slate-400 text-sm">View branch reports and statistics</p>
          </div>
        </div>
      </div>
    </div>
